...
const scrollMovEl = document.querySelectorAll("[data-animation-scroll='true']");
for(let i = 0; i < scrollMovEl . length; i++){
    scrollMovEl[i] .addEventListener('click' , function(e){
